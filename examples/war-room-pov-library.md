# War Room — POV Library & Voice Guide

> **What this is:** The canonical "house takes" for War Room content — the source-of-truth the
> [Content Calendar Strategist](../marketing/marketing-content-calendar-strategist.md) agent draws
> from so generated content sounds like War Room and carries opinions the team actually holds.
>
> Every content cluster in the [calendar strategy](war-room-content-calendar-strategy.md) should
...
## Deep POV Bank
Each POV is written as a one-sentence take strong enough to disagree with, plus the fuller argument, the proof, and who voices it. Quotes are drawn from the team's own survey answers.

### Pillar — AI, For Real

**POV 1 · "AI should amplify human expertise, not replace it."**
...
- **Voice:** Performance Lead (paid), AI Lead (AI perspective).
...
1. Pull the relevant **POV** for the pillar being planned.
2. Attach a **proof point** from the library (mandatory).
3. Assign the mapped **spokesperson**.
4. Atomize into a content cluster (pillar piece + derivatives + speaking abstract).
5. Check against **Do/Don't** and **Guardrails** before it ships.
